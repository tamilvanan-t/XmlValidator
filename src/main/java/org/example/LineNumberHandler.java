...
public class LineNumberHandler extends DefaultHandler {
    ...
    final static String TAG_END_LINE_NUMBER_KEY_NAME = "tagEndLineNumber";
    final static String TAG_END_COLUMN_NUMBER_KEY_NAME = "tagEndColumnNumber";
    ...
    public void startElement(final String uri, final String localName,
        ...
        el.setUserData(COLUMN_NUMBER_KEY_NAME,
    ...
    public void endElement(final String uri, final String localName,
        ...
        closedEl.setUserData(TAG_END_LINE_NUMBER_KEY_NAME,
                String.valueOf(this.locator.getLineNumber()), null);
        closedEl.setUserData(TAG_END_COLUMN_NUMBER_KEY_NAME,
                String.valueOf(this.locator.getColumnNumber()), null);
